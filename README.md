...
## Screenshots
![Screenshot](https://imgur.com/TAqHNli.png)
...
Config.MaxInventoryWeight = 25000 -- Max weight a player can carry (default 120kg, written in grams)
...
Config.AttachmentCraftingLocation = vector3(88.91, 3743.88, 4.77) -- Only needed if not using target
